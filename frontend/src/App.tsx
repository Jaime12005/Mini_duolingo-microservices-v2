...
function Sidebar() {
  ...
  const displayName = user?.displayName ?? user?.username ?? 'Aprendiz'

  return (
    <aside className="sidebar">
      <Link to="/content" className="sidebar-logo">
        <img src="/Imagen2.png" alt="logo" />
        <span>Miniduolingo</span>
      </Link>
      ...
      <div className="sidebar-user">
        {user?.avatarUrl ? (
          <img className="sidebar-avatar" src={user.avatarUrl} alt="avatar" />
        ) : (
        ...
        <div className="sidebar-user-info">
          <span className="sidebar-user-name">Hola, {displayName}</span>
